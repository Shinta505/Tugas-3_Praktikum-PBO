...
public class ViewDosen extends JFrame {
    ...
    public ViewDosen() {
        ...
        kembali.setBounds(20, 506, 512, 40);
        ...
        tombolEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (baris != null) {
                    ...
                    // Menyimpan informasi id, nama, dan nidn ke objek "mahasiswaTerpilih".
        ...
        // Memberikan event handling ketika tombol "Kembali" diklik
        kembali.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Ketika tombol kembali diklik, maka program akan kembali ke halaman sebelumnya
                dispose();
                new HalamanUtama();
            }
        });
